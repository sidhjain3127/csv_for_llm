...
db = FAISS.load_local('csv_for_llm/data/faiss_index', HuggingFaceEmbeddings(model_name='sentence-transformers/all-mpnet-base-v2'))
...
print("Model loaded and FAISS index retrieved successfully.")
